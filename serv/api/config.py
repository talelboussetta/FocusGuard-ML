...
class Settings(BaseSettings):
    ...
    # ========================================================================
    # RAG & Vector Store Settings (Supabase pgvector)
    # ========================================================================
    ...
    supabase_key: str = Field(
        default="",
        description="Supabase Service Role Key (for secure backend access)"
    )
    
    supabase_collection_name: str = Field(
        default="documents",
        description="Name of the vector collection/table in Supabase"
    )
